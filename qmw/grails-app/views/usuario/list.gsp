...
<html>
	...
	<body>
		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			<h1><g:message code="default.show.label" args="[entityName]" />   <g:helpBalloon code="usuario.label" mostra="true"/></h1>
			...
			<table>
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usuarioInstance.id}">${fieldValue(bean: usuarioInstance, field: "codigo")}</g:link></td>
